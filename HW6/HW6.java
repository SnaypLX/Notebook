...
public class HW6 {
   public static void main(String[] args) {
      Notebook notebook1 = new Notebook("Asus", "32", "250", "Windows", "grey");
      Notebook notebook2 = new Notebook("Asus", "32", "512", "Linux", "black");
      Notebook notebook3 = new Notebook("Asus", "32", "250", "Windows", "black");
      Notebook notebook4 = new Notebook("Asus", "16", "512", "Windows", "grey");
      Notebook notebook5 = new Notebook("Huawei", "64", "512", "Windows", "black");
